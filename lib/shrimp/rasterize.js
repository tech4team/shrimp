...
function renderUrl(url, output, options) {
  ...
  if (system.args[15]) {
    page.customHeaders = {
      "Accept-Language": system.args[15]
    };
  };
...
if (system.args.length < 3 || system.args.length > 16) {
  console.log('i see',system.args.length,'args -> ',system.args);
  ...
  if (system.args[13] && system.args[14]) {
      ...
      header: {
        ...
        footer: {
          ...
          contents: phantom.callback(function(pageNum, numPages) {
            ...
            return "<center>"+ pageNum + " / " + numPages + "</center>"+system.args[14];
        })
      }
    };
  }
